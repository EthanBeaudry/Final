...
{
    public partial class NWConsole_96_EJBContext : DbContext
    {
        public NWConsole_96_EJBContext()
        {
        }

        public NWConsole_96_EJBContext(DbContextOptions<NWConsole_96_EJBContext> options)
            : base(options)
        {
        }
